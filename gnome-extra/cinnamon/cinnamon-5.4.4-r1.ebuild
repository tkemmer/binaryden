...
RDEPEND="
	...
	>=x11-libs/xapp-2.2.11[introspection]
	x11-misc/xdg-utils
...
PATCHES=(
	...
	# Fix window freezing after workspace switching
	# https://github.com/linuxmint/cinnamon/issues/10943
	"${FILESDIR}"/${PN}-5.4.3-fix-workspace-switching.patch
)
