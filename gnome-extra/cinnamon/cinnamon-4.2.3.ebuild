...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	gnome-base/librsvg
	>=gnome-extra/cinnamon-desktop-4.2:0=[introspection]
	>=gnome-extra/cinnamon-menus-4.2
	>=gnome-extra/cjs-4.2.0[cairo]
	...
	>=x11-wm/muffin-4.2.0[introspection]
...
RDEPEND="${COMMON_DEPEND}
	...
	>=gnome-extra/cinnamon-session-4.2
	>=gnome-extra/cinnamon-settings-daemon-4.2
	...
	>=gnome-extra/nemo-4.2
	>=gnome-extra/cinnamon-control-center-4.2
	>=gnome-extra/cinnamon-screensaver-4.2
